...
$query1="Select * from Apprisal where Manager_ID='$Manager_ID' and Status in (2,3,4,5,6)";
// echo($query1);
...
<body>
  <h1>Employee's Appraisal list</h1>
...
?>
          <tr>
            ...
            <td> <?php 
            if($row2['Status']==2){
               echo '<a href="2nd_Index_Manager.php?Emp_ID='.$row2['Emp_ID'].'">Click here!</a>';
            }
            else{
              echo '<p>Done</p>';
            } ?>
            </td>
            <td> <a href="Apprisal_Manager.php?Emp_ID=<?php echo $row2['Emp_ID'];?>">View Appraisal!</a></td>
            <td> <?php
            if($row2['Status']==3){
               echo '<a href="Update_Apprisal_Manager.php?Emp_ID='.$row2['Emp_ID'].'">Update Appraisal!</a>';
            }
            else{
              echo '<p>Done</p>';
            }?>
