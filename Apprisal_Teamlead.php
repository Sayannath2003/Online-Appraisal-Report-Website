...
<body class="container mt-9">
    ...
    <header class="header">
        <div class="first">
            <h1><a href="https://www.google.com/">Your Remarks(Teamlead)</a></h1>
        </div>
    ...
    <div class="container mt-5">
        ...
        <div class="form-group">
                ...
                <input type="text" class="form-control" id="Teamlead_ID" value="<?php echo $row['Teamlead_ID'];  ?>"  name="Teamlead_ID" readonly>
            </div>
            <div class="form-group">
                ...
                <table cellspacing="2" cellpading="5" border="1">
                    ...
                    <tbody>
                        <tr>                            
                            ...
                            <td><span><?php echo $row['Overall_L'] ?></span></td> 
                        </tr>                        
                    </tbody>
                </table>
            </div>            
