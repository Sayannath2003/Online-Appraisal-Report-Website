...
<!-- Emp er ota -->
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="Indicate_Areas_Of_Strength_And_Lesser_Strength" name="Indicate_Areas_Of_Strength_And_Lesser_Strength" rows="4"></textarea>
            </div>

            <div class="form-group">
                <label for="Attitude">2. Attitude towards Schedule Classes/Schedule Tribes/Weaker sections of society:</label>
                <textarea class="form-control" id="Attitude" name="Attitude" rows="4"></textarea>
            </div>

            <div class="form-group">
                <label for="Relation_With_Outside">3. Relation with outside agencies/public:</label>
                <textarea class="form-control" id="Relation_With_Outside" name="Relation_With_Outside" rows="4"></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="Recommendations_For_Training" name="Recommendations_For_Training" rows="4"></textarea>
            </div>

            <div class="form-group">
                <label for="State_Of_Health">5. State of health:</label>
                <textarea class="form-control" id="State_Of_Health" name="State_Of_Health" rows="4"></textarea>
            </div>

            <div class="form-group">
                <label for="Integrity">6. Integrity:</label>
                <textarea class="form-control" id="Integrity" name="Integrity" rows="4"></textarea>
            </div>
                ...
                <table cellspacing="2" cellpading="5" border="1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="number" class="form-control" id="Attitude_Point_M" name="Attitude_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Sense of Responsibility</td>
                            <td><input type="number" class="form-control" id="Sense_Of_Responsibility_Point_M" name="Sense_Of_Responsibility_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>Maintenance of Discipline</td>
                            <td><input type="number" class="form-control" id="Maintenance_Of_Discipline_Point_M" name="Maintenance_Of_Discipline_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>Communication Skill</td>
                            <td><input type="number" class="form-control" id="Communication_Skills_Point_M" name="Communication_Skills_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>5</td>
                            <td>Leadership Quality</td>
                            <td><input type="number" class="form-control" id="Leadership_Quality_Point_M" name="Leadership_Quality_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>6</td>
                            <td>Capacity to work in team spirit</td>
                            <td><input type="number" class="form-control" id="Capacity_To_Work_In_Teamspirit_Point_M" name="Capacity_To_Work_In_Teamspirit_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>7</td>
                            <td>Capacity to work in time limit</td>
                            <td><input type="number" class="form-control" id="Capacity_To_Work_In_Timelimit_Point_M" name="Capacity_To_Work_In_Timelimit_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>8</td>
                            <td>Inter-personal relations</td>
                            <td><input type="number" class="form-control" id="Inter_Personal_Relations_Point_M" name="Inter_Personal_Relations_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>~</td>
                            <td><b>Overall Grading on "PERSONAL ATTRIBUTES"</b></td>
                            <td><input type="number" class="form-control" id="Overall_Grading_Personal_Attributes_M" name="Overall_Grading_Personal_Attributes_M" step="0.1" readonly ></td> <!-- step kaj korche na-->
                        </tr>
                        <?php
                ...
                <table cellspacing="2" cellpading="5" border="1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="number" class="form-control" id="Knowledge_Of_Rules_Point_M" name="Knowledge_Of_Rules_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Strategic planning ability</td>
                            <td><input type="number" class="form-control" id="Strategic_Planning_Ability_Point_M" name="Strategic_Planning_Ability_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>Decision making ability</td>
                            <td><input type="number" class="form-control" id="Decision_Making_Ability_Point_M" name="Decision_Making_Ability_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>Co-ordination ability</td>
                            <td><input type="number" class="form-control" id="Coordination_Ability_Point_M" name="Coordination_Ability_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>5</td>
                            <td>Ability to motivate and develop subordinates</td>
                            <td><input type="number" class="form-control" id="Ability_To_Motivate_And_Develop_Point_M" name="Ability_To_Motivate_And_Develop_Point_M" step="0.1" required ></td> <!-- step kaj korche na-->
                        </tr>
                        <tr>
                            <td>~</td>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="Pen_Picture_About_Officer_M" name="Pen_Picture_About_Officer_M" rows="4"></textarea>
            </div>
