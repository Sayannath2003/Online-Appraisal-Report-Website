...
$today=date("Y-m-d");
// echo $Emp_ID;
$query="Select * from Teamlead where Teamlead_ID='$Teamlead_ID'";
// echo($query."<br>");

$result1 = $objconn->prepare($query);
$result1->execute();
$row = $result1->fetch(PDO::FETCH_ASSOC); 
// echo $row1['Manager_Name'];
// print_r($row);
...
<head>
    ...
    <title>Appraisal page for Teamlead</title>
</head>
<body>
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
        ...
        <div class="first">
            <h1><a href="https://www.google.com/">Annual Appraisal Report(Teamlead)</a></h1>
        </div>
    ...
    <div class="container mt-1" style="width:300px">
        ...
        <div class="card-body">
            <h4 class="card-title"><?php echo $Teamlead_ID ?></h4>
            <p class="card-text"><?php echo $row['Teamlead_Name']; ?></p>
            <a href="2nd_Index_Manager_Profile.php" class="btn btn-primary">See Profile</a>
        </div>
    </div>
    <div class="container mt-5">
        <form action="2nd_Index_FormSQL_Teamlead2.php" method="post">
                ...
                <table cellspacing="2" cellpading="5" border="1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="number" class="form-control" id="Attitude_Point_L" name="Attitude_Point_L" value="<?php echo $row1['Attitude_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Sense of Responsibility</td>
                            <td><span><?php echo $row1['Sense_Of_Responsibility_Point_M']; ?></span></td>
                            <td><input type="number" class="form-control" id="Sense_Of_Responsibility_Point_L" name="Sense_Of_Responsibility_Point_L" value="<?php echo $row1['Sense_Of_Responsibility_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>Maintenance of Discipline</td>
                            <td><span><?php echo $row1['Maintenance_Of_Discipline_Point_M']; ?></span></td>
                            <td><input type="number" class="form-control" id="Maintenance_Of_Discipline_Point_L" name="Maintenance_Of_Discipline_Point_L" value="<?php echo $row1['Maintenance_Of_Discipline_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>Communication Skill</td>
                            <td><span><?php echo $row1['Communication_Skills_Point_M']; ?></span></td> 
                            <td><input type="number" class="form-control" id="Communication_Skills_Point_L" name="Communication_Skills_Point_L" value="<?php echo $row1['Communication_Skills_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>5</td>
                            <td>Leadership Quality</td>
                            <td><span><?php echo $row1['Leadership_Quality_Point_M']; ?></span></td> 
                            <td><input type="number" class="form-control" id="Leadership_Quality_Point_L" name="Leadership_Quality_Point_L" value="<?php echo $row1['Leadership_Quality_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>6</td>
                            <td>Capacity to work in team spirit</td>
                            <td><span><?php echo $row1['Capacity_To_Work_In_Teamspirit_Point_M']; ?></span></td> 
                            <td><input type="number" class="form-control" id="Capacity_To_Work_In_Teamspirit_Point_L" name="Capacity_To_Work_In_Teamspirit_Point_L" value="<?php echo $row1['Capacity_To_Work_In_Teamspirit_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>7</td>
                            <td>Capacity to work in time limit</td>
                            <td><span><?php echo $row1['Capacity_To_Work_In_Timelimit_Point_M']; ?></span></td> 
                            <td><input type="number" class="form-control" id="Capacity_To_Work_In_Timelimit_Point_L" name="Capacity_To_Work_In_Timelimit_Point_L" value="<?php echo $row1['Capacity_To_Work_In_Timelimit_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>8</td>
                            <td>Inter-personal relations</td>
                            <td><span><?php echo $row1['Inter_Personal_Relations_Point_M']; ?></span></td>
                            <td><input type="number" class="form-control" id="Inter_Personal_Relations_Point_L" name="Inter_Personal_Relations_Point_L" value="<?php echo $row1['Inter_Personal_Relations_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>~</td>
                            <td><b>Overall Grading on "PERSONAL ATTRIBUTES"</b></td>
                            <td><span><?php echo $row1['Overall_Grading_Personal_Attributes_M']; ?></span></td>
                            <td><input type="number" class="form-control" id="Overall_Grading_Personal_Attributes_L" name="Overall_Grading_Personal_Attributes_L" step="0.1" readonly ></td>
                        </tr>
                ...
                <table cellspacing="2" cellpading="5" border="1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="number" class="form-control" id="Knowledge_Of_Rules_Point_L" name="Knowledge_Of_Rules_Point_L" value="<?php echo $row1['Knowledge_Of_Rules_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>2</td>
                            <td>Strategic planning ability</td>
                            <td><span><?php echo $row1['Strategic_Planning_Ability_Point_M']; ?></span></td> 
                            <td><input type="number" class="form-control" id="Strategic_Planning_Ability_Point_L" name="Strategic_Planning_Ability_Point_L" value="<?php echo $row1['Strategic_Planning_Ability_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>3</td>
                            <td>Decision making ability</td>
                            <td><span><?php echo $row1['Decision_Making_Ability_Point_M']; ?></span></td> 
                            <td><input type="number" class="form-control" id="Decision_Making_Ability_Point_L" name="Decision_Making_Ability_Point_L" value="<?php echo $row1['Decision_Making_Ability_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>Co-ordination ability</td>
                            <td><span><?php echo $row1['Coordination_Ability_Point_M']; ?></span></td>
                            <td><input type="number" class="form-control" id="Coordination_Ability_Point_L" name="Coordination_Ability_Point_L" value="<?php echo $row1['Coordination_Ability_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>5</td>
                            <td>Ability to motivate and develop subordinates</td>
                            <td><span><?php echo $row1['Ability_To_Motivate_And_Develop_Point_M']; ?></span></td> 
                            <td><input type="number" class="form-control" id="Ability_To_Motivate_And_Develop_Point_L" name="Ability_To_Motivate_And_Develop_Point_L" value="<?php echo $row1['Ability_To_Motivate_And_Develop_Point_L']; ?>" step="0.1" required ></td>
                        </tr>
                        <tr>
                            <td>~</td>
                            <td><b>Overall Grading on "FUNCTIONAL COMPETENCY"</b></td>
                            <td><span><?php echo $row1['Overall_Grading_Functional_Competency_M']; ?></span></td>
                            <td><input type="number" class="form-control" id="Overall_Grading_Functional_Competency_L" name="Overall_Grading_Functional_Competency_L" step="0.1" readonly ></td> <!-- step kaj korche na-->
                        </tr>
                ...
                <table cellspacing="2" cellpading="5" border="1">
                    ...
                    <tbody>
                        <tr>                            
                            ...
                            <td><input type="number" class="form-control" id="Overall_L" value="<?php $row1['Overall_L']; ?>" name="Overall_L" step="0.1" readonly ></td>
                        </tr>                        
                    </tbody>
                </table>
            </div>
