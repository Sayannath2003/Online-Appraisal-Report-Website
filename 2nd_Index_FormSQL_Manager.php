...
$appraisalDate_Manager=$_POST["appraisalDate_Manager"];
$Emp_ID_Manager=$_POST["Emp_ID_Manager"];

$Indicate_Areas_Of_Strength_And_Lesser_Strength=$_POST["Indicate_Areas_Of_Strength_And_Lesser_Strength"];
$Attitude=$_POST["Attitude"];
$Relation_With_Outside=$_POST["Relation_With_Outside"];
$Recommendations_For_Training=$_POST["Recommendations_For_Training"];
$State_Of_Health=$_POST["State_Of_Health"];
$Integrity=$_POST["Integrity"];
// Table 1
$Attitude_Point_M=$_POST["Attitude_Point_M"];
$Sense_Of_Responsibility_Point_M=$_POST["Sense_Of_Responsibility_Point_M"];
$Maintenance_Of_Discipline_Point_M=$_POST["Maintenance_Of_Discipline_Point_M"];
$Communication_Skills_Point_M=$_POST["Communication_Skills_Point_M"];
$Leadership_Quality_Point_M=$_POST["Leadership_Quality_Point_M"];
$Capacity_To_Work_In_Teamspirit_Point_M=$_POST["Capacity_To_Work_In_Teamspirit_Point_M"];
$Capacity_To_Work_In_Timelimit_Point_M=$_POST["Capacity_To_Work_In_Timelimit_Point_M"];
$Inter_Personal_Relations_Point_M=$_POST["Inter_Personal_Relations_Point_M"];
$Overall_Grading_Personal_Attributes_M=($Attitude_Point_M+$Sense_Of_Responsibility_Point_M+$Maintenance_Of_Discipline_Point_M+$Communication_Skills_Point_M+$Leadership_Quality_Point_M+$Capacity_To_Work_In_Teamspirit_Point_M+$Capacity_To_Work_In_Timelimit_Point_M+$Inter_Personal_Relations_Point_M)/8;
// Table 2
$Knowledge_Of_Rules_Point_M=$_POST["Knowledge_Of_Rules_Point_M"];
$Strategic_Planning_Ability_Point_M=$_POST["Strategic_Planning_Ability_Point_M"];
$Decision_Making_Ability_Point_M=$_POST["Decision_Making_Ability_Point_M"];
$Coordination_Ability_Point_M=$_POST["Coordination_Ability_Point_M"];
$Ability_To_Motivate_And_Develop_Point_M=$_POST["Ability_To_Motivate_And_Develop_Point_M"];
$Overall_Grading_Functional_Competency_M=($Knowledge_Of_Rules_Point_M+$Strategic_Planning_Ability_Point_M+$Decision_Making_Ability_Point_M+$Coordination_Ability_Point_M+$Ability_To_Motivate_And_Develop_Point_M)/5;
$Pen_Picture_About_Officer_M=$_POST["Pen_Picture_About_Officer_M"];
$Overall_M=($Overall_Grading_Personal_Attributes_M+$Overall_Grading_Functional_Competency_M)/2;
...
$query = "UPDATE apprisal SET Manager_ID = '$Manager_ID', Manager_Name = '$Manager_Name', appraisalDate_Manager = '$appraisalDate_Manager', Indicate_Areas_Of_Strength_And_Lesser_Strength = '$Indicate_Areas_Of_Strength_And_Lesser_Strength', Attitude = '$Attitude', Relation_With_Outside = '$Relation_With_Outside', Recommendations_For_Training = '$Recommendations_For_Training', State_Of_Health = '$State_Of_Health', Integrity = '$Integrity', Attitude_Point_M = '$Attitude_Point_M', Sense_Of_Responsibility_Point_M = '$Sense_Of_Responsibility_Point_M', Maintenance_Of_Discipline_Point_M = '$Maintenance_Of_Discipline_Point_M', Communication_Skills_Point_M = '$Communication_Skills_Point_M', Leadership_Quality_Point_M = '$Leadership_Quality_Point_M', Capacity_To_Work_In_Teamspirit_Point_M = '$Capacity_To_Work_In_Teamspirit_Point_M', Capacity_To_Work_In_Timelimit_Point_M = '$Capacity_To_Work_In_Timelimit_Point_M', Inter_Personal_Relations_Point_M = '$Inter_Personal_Relations_Point_M', Overall_Grading_Personal_Attributes_M = '$Overall_Grading_Personal_Attributes_M', Knowledge_Of_Rules_Point_M = '$Knowledge_Of_Rules_Point_M', Strategic_Planning_Ability_Point_M = '$Strategic_Planning_Ability_Point_M', Decision_Making_Ability_Point_M = '$Decision_Making_Ability_Point_M', Coordination_Ability_Point_M = '$Coordination_Ability_Point_M', Ability_To_Motivate_And_Develop_Point_M = '$Ability_To_Motivate_And_Develop_Point_M', Overall_Grading_Functional_Competency_M = '$Overall_Grading_Functional_Competency_M', Pen_Picture_About_Officer_M = '$Pen_Picture_About_Officer_M', Overall_M = '$Overall_M', Status=$Status WHERE Emp_ID = '$Emp_ID_Manager'";
...
$result->execute();
// $Overall_M=($row1['Overall_Grading_Personal_Attributes_M']+$row1['Overall_Grading_Functional_Competency_M'])/2;
                ...
                <table cellspacing="2" cellpading="5" border="1">
                    ...
                    <tbody>
                        <tr>                            
                            ...
                            <td><span><?php echo $Overall_M; ?></span></td> <!-- step kaj korche na-->
                        </tr>                        
                    </tbody>
                </table>
            </div>            
...
<!-- Appraisal End -->
<p>Want to go to the 1st Page?? <a href="./Choose_Apprisal_Manager.php">Click here!!</a></p>

<form action="Review_And_Update_Apprisal_Manager.php" method="get">
    <input type="hidden" name="Emp_ID" value="<?php //echo $Emp_ID ?>">
    <input type="submit" name="sub1" value="Review and Update">
</form>
