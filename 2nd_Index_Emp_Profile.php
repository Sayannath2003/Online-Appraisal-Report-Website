...
<body>
    ...
    <div class="alert alert-warning container" role="alert">
        ...
        <br>
        <h1>Name : <?php echo $row['Emp_Name']; ?></h1>
        <br>
        <h1>Department : <?php echo $row['Emp_Dept']; ?></h1>
        <br>
        <h1>Age : <?php echo $row['Emp_Age']; ?></h1>
        <br>
        <h1>Address : <?php echo $row['Emp_Address']; ?></h1>
        <br>
        <h1>Phone number : <?php echo $row['Emp_Phone_No']; ?></h1>
        <br>
        <h1>Joining Date : <?php echo $row['Emp_Joining_Date']; ?></h1>
        <br>
        <h1>Email : <?php echo $row['Emp_Email']; ?></h1>
    </div>
    <!-- <div class="card">
  ...
  <div class="desc">
        <b>Employee ID : <?php //echo $row['Emp_ID']; ?></b>
        <br>
        Name : <?php// echo $row['Emp_Name']; ?>
        <br>
        Department : <?php// echo $row['Emp_Dept']; ?>
        <br>
        Age : <?php //echo $row['Emp_Age']; ?>
        <br>
        Address : <?php //echo $row['Emp_Address']; ?>
        <br>
        Phone number : <?php// echo $row['Emp_Phone_No']; ?>
        <br>
        Joining Date : <?php// echo $row['Emp_Joining_Date']; ?>
        <br>
        Email : <?php //echo $row['Emp_Email']; ?>
  </div>
  </div> -->
